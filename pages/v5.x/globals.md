...
* `files` {Set}
* `groupsIterable` {SortableSet} Gets groups iterable.
* `hash` {string}
* `id` {string|number}
...
* `optionalBuildDependencies` {LazySet}
...
* `useSourceMap` {boolean}
* `warnings` {any}
* `NO_CHUNK_HANDLERS` {string|string[]} The answer a runtime module gives when it installs no chunk handler at all
...
* `this` {NormalModuleLoaderContext|LoaderRunnerMutableContext|LoaderRunnerReadonlyContext|LoaderPluginLoaderContext|HotModuleReplacementPluginLoaderContext|ContextAdditions}
* `content` {string}
* `sourceMap` {string|RawSourceMap}
...
> **DefineConfigInput** = {Configuration|MultiConfiguration|object|object[]|Promise}
...
> **LoaderContext**\<`OptionsType`\> = {NormalModuleLoaderContext|LoaderRunnerMutableContext|LoaderRunnerReadonlyContext|LoaderPluginLoaderContext|HotModuleReplacementPluginLoaderContext}
...
Re-exports [ConfigurationFactory](#configurationfactory)
...
Re-exports [CopyPlugin](#copyplugin)
...
Re-exports [DefineConfigInput](#defineconfiginput)
...
Re-exports [PathDataChunk](#pathdatachunk-1)

***

## `PathDataModule`

Re-exports [PathDataModule](#pathdatamodule-1)
...
Re-exports [SSRManifestPlugin](#ssrmanifestplugin)
